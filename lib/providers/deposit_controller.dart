...
/// Gère la soumission d'un dépôt et rafraîchit le Dashboard en cas de succès.
class DepositController extends AsyncNotifier<void> {
  @override
  FutureOr<void> build() {}

  Future<bool> submit({required double amount}) async {
...
final depositControllerProvider =
    AsyncNotifierProvider<DepositController, void>(DepositController.new);
